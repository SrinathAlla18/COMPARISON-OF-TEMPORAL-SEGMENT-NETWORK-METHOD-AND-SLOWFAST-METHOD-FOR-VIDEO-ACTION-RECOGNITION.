...
model = dict(cls_head=dict(num_classes=24, init_std=0.001))

# dataset settings
dataset_type = 'RawframeDataset'
data_root = 'data/UCF101_v2/brox-images'
data_root_val = 'data/UCF101_v2/brox-images'
ann_file_train = 'data/UCF101_v2/train_ucf.txt'
ann_file_val = 'data/UCF101_v2/test_ucf.txt'
ann_file_test = 'data/UCF101_v2/test_ucf.txt'
...
# optimizer
optimizer = dict(
    type='SGD', lr=0.0016, momentum=0.9,
